 ...
 * Created by mark
 */
public class VisualForceComponentFileType extends LanguageFileType {

    public static final VisualForceComponentFileType INSTANCE = new VisualForceComponentFileType();

    public VisualForceComponentFileType() {
    ...
    public String getDescription() {
        return "Visualforce component file";
    }
    ...
    @Override
    public Icon getIcon() {
        return Icons.VisualforceFileType.COMPONENT;
    }
