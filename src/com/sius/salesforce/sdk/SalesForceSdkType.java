package com.sius.salesforce.sdk;
...
public class SalesForceSdkType extends JavaDependentSdkType implements JavaSdkType {
    ...
    public static JavaSdkVersion getRequiredSdkVersion(Sdk salesForceSdk) {
        ...
        try {
            ...
            classFileVersion = SalesForceSdkType.getCompiledMajorMinorVersions(new DataInputStream(classFile.getInputStream()));
        } catch (IOException e) {
            // ignore
        }
     ...
     */
    private static int getCompiledMajorMinorVersions(
        ...
        try {
            ...
            if (!firstFourBytes.equalsIgnoreCase("cafebabe")) {
                throw new IllegalArgumentException("is NOT a Java .class file.");
            }
            ...
            System.out.println(
                    "ERROR: Unable to process file to determine JDK compiled version - " + exception);
            return -1;
        }
    }
