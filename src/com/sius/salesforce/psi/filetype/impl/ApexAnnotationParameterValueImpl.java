...
import static au.com.borner.salesforce.plugin.apex.psi.ApexTypes.STRING_LITERAL;

public class ApexAnnotationParameterValueImpl extends ASTWrapperPsiElement implements ApexAnnotationParameterValue {

  public ApexAnnotationParameterValueImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ApexVisitor) ((ApexVisitor)visitor).visitAnnotationParameterValue(this);
